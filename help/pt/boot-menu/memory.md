...
`zramsize=` define o tamanho do zRAM em MiB. Deixe o campo vazio para permitir que o MiniOS
calcule o tamanho automaticamente. Um valor maior não é memória física livre:
